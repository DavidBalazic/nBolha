//
//  DeleteProfilePictureWorker.swift
//  nBolhaNetworking
//
...
public class DeleteProfilePictureWorker: BaseNBolhaWorker<String> {

    public override func getUrl() -> String {
        return super.getUrl() + NBolhaApi.Endpoint.deleteProfilePicture.path
    }
